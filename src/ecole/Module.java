...
public class Module {
	...
	public void setSemestres(Boolean[] vsemestres) {
		this.semestres = vsemestres;
	}

	public void setListeMatieres(Matiere[] vlisteMatieres) {
		this.listeMatieres = vlisteMatieres;
	}
	...
	public Boolean[] getSemestres() {
		return this.semestres;
	}

	public Matiere[] getListeMatieres() {
